...
import ins1 from '@/assets/images/inner.png';
import ins2 from '@/assets/images/Rectangle.png';
import ins3 from '@/assets/images/room.jpg';
...
const Insparation = () => {
  ...
  return (
    <div className="py-16 selection:bg-[#FCF8F3]">
