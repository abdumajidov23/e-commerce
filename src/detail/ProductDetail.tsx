          ...
          <div className="flex">
            <div className="product__detail flex flex-col space-y-4 mr-4 overflow-y-auto h-80 no-scrollbar">
              {product?.images.map((img, index) => (
                <img
                  key={index}
                  src={`${import.meta.env.IMAGE_BASE_URL}${img}`}
            ...
            <div>
              <div className="w-full max-w-lg h-80 overflow-hidden">
                <img
                  src={`${import.meta.env.IMAGE_BASE_URL}${
                  ...
                  onClick={() => {
                    setModalImage(
                      `${import.meta.env.IMAGE_BASE_URL}${
                        product.images[selectedImage]
                      }`
                    );
                    setIsModalOpen(true);
        ...
        <div className="mt-32 grid grid-cols-2 gap-10 mb-14">
          {product.images.slice(0, 2).map((img, index) => (
            <img
              ...
              onClick={() => {
                setModalImage(`${import.meta.env.IMAGE_BASE_URL}${img}`);
                setIsModalOpen(true);
              }}
            />
          ))}
